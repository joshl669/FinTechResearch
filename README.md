...
Clients include – Instacart, DoorDash, Postmates, Zoom and Caviar

*Is there any information about the market size of this set of customers?*

The market is reaching above $2 Trillion and growing.
...
- Pay as you go pricing and uniform fee rate


- Partnership with Amazon – Stripe handles an undisclosed amount of transactions for the company.

- Network structure and technology - Stripe's interface is seamless and easily highlights bank transfers and HTTP request logs.

- Stripe's API is highly valuable
...
- Companies that joined Stripe in March of 2020 have already generated $1B in revenue
...
- actively targeting payment flows related to demographics, such as the compensation and pension flows linked to the baby boomer generation, or the emerging middle classes in China and Indonesia, - - targeting high-growth and traditionally poorly served customer segments such as small and medium sized enterprises (SMEs), 
...
Stripe has managed to capture 3% of the market and revenues are somewhere around $3.4B

Stripe has built a reputation for its technology and API

*How is your company performing relative to competitors in the same domain?*
It is competitive and maintaining itself as a key player behind Paypal and other large Banks and FinTech companies.
...
The volume that Stripe has could generate more revenue by utilizing a business model such as Digits. It  would be a pathway into another market, asset management. If they are key players in transactions then the next step would be into asset management and using code or technology to provide strategies to manage capital more efficiently. 

*What technologies would this additional product or service utilize?*

APIs and being able to connect with Banks, Investment Advisors or Wealth Management, Credit Card Companies, and financial services.

*Why are these technologies appropriate for your solution?*
The data infrastructure they use to connect the different networks.
...
https://www.aciworldwide.com/-/media/files/collateral/trends/payments-innovation-jury-report.pdf

https://www2.deloitte.com/content/dam/Deloitte/ru/Documents/financial-services/fintech-by-the-numbers.pdf
https://www.crunchbase.com/organization/stripe#section-overview
...
https://medium.com/@adamodigital/comparing-stripe-vs-braintree-vs-paypal-6b7b8ee91486
...
https://www.quora.com/What-sets-Stripe-apart-from-its-competitors
